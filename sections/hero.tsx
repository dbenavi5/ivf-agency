...
const URL = 'https://res.cloudinary.com/dpj6rkbus/image/upload/v1727816812/pregnant-6178270_1280_fctoiu.jpg';
export const Hero = () => {
  return (
    <section className="relative overflow-hidden min-h-[500px] h-auto lg:h-[60vh] -mt-[100px]">
      <DynamicImages
        url={URL}
        alt="Hero Image"
      ...
      <div className="container">
        <div className="relative z-10 text-center justify-center mb-20">
          <h1 className="text-4xl lg:text-5xl font-bold tracking-tighter bg-gradient-to-b from-white to-[#f4acb7] text-transparent bg-clip-text mt-48 z-10">
