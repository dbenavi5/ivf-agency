...
export const Pricing = () => {
  return (
    <section id="pricing" className="relative mb-24 scroll-mt-24">
      <h2 className="text-3xl lg:text-4xl font-bold text-mainColor flex items-center justify-center mb-6 lg:mb-12">
        Pricing
      </h2>
      <div className="container mx-auto">
        ...
        <MotionDiv
          ...
          className="relative w-full max-w-4xl p-8 rounded-[30px] bg-[#d9b99b]/10 overflow-hidden"
        >
          ...
          <div className="relative z-10 grid gap-8 grid-cols-1 lg:grid-cols-2 text-center">
            ...
            <div className="bg-white bg-opacity-10 text-center p-6 rounded-lg shadow-md transition-transform transform hover:scale-105 hover:bg-opacity-20">
              <div className="flex items-center justify-center">
                <FaSyringe className="text-4xl text-mainColor mb-4" />
              </div>
            ...
            <div className="bg-white bg-opacity-10 p-6 rounded-lg shadow-md transition-transform transform hover:scale-105 hover:bg-opacity-20">
              <div className="flex items-center justify-center">
                <LiaSuperpowers className="text-4xl text-mainColor mb-4" />
              </div>
            ...
            <div className="bg-white bg-opacity-10 p-6 rounded-lg shadow-md transition-transform transform hover:scale-105 hover:bg-opacity-20">
              <div className="flex items-center justify-center">
                <FaUserMd className="text-4xl text-mainColor mb-4" />
              </div>
            ...
            <div className="bg-white bg-opacity-10 p-6 rounded-lg shadow-md transition-transform transform hover:scale-105 hover:bg-opacity-20">
              <div className="flex items-center justify-center">
                <MdOutlineAddLocation className="text-4xl text-mainColor mb-4" />
              </div>
              <h3 className="text-lg font-bold">
